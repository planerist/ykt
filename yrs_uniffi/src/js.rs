...
//
// pub enum Shared {
//     Text(Arc<RefCell<YText>>),
//     Map(Arc<RefCell<YMap>>),
//     Array(Arc<RefCell<YArray>>),
//     Weak(Arc<RefCell<YWeakLink>>),
//     XmlText(Arc<RefCell<YXmlText>>),
//     XmlElement(Arc<RefCell<YXmlElement>>),
//     XmlFragment(Arc<RefCell<YXmlFragment>>),
//     Doc(Arc<RefCell<YDoc>),
// }
//
// impl Shared {
